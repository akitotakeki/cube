...
replot "res_ide8.log.train" using 1:3 title "res_ide8_lr_0.01_train" lt 0 lc rgb "green"
replot "res_ide8.log.test" using 1:4 title "res_ide8_lr_0.01_test" lc rgb "green"
